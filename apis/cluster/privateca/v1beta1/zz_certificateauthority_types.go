...
type CertificateAuthorityParameters struct {
	...
	// The name of the CaPool this Certificate Authority belongs to.
	// +crossplane:generate:reference:type=github.com/upbound/provider-gcp/apis/cluster/privateca/v1beta1.CAPool
	// +kubebuilder:validation:Optional
	Pool *string `json:"pool,omitempty" tf:"pool,omitempty"`
...
type SubordinateConfigInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-gcp/apis/cluster/privateca/v1beta1.CertificateAuthority
