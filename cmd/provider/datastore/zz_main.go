...
import (
	...
	clusterconfig "github.com/upbound/provider-gcp/config/cluster"
	namespacedconfig "github.com/upbound/provider-gcp/config/namespaced"
...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_datastore(mgr, clusterOpts), "Cannot setup cluster-scoped GCP controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_datastore(mgr, namespacedOpts), "Cannot setup namespaced GCP controllers")
